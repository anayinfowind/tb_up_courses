...
/**
 * Move/order course functionality for tb_up_courses block.
 *
...
list($courses, $sitecourses, $coursecount) = block_tb_up_courses_get_sorted_courses();
...
block_tb_up_courses_update_myorder(array_values($neworder));
redirect(new moodle_url('/my/index.php'));
